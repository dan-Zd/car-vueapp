<template>
  <f7-page id="feeRecord" navbar-fixed>
    <f7-navbar>
      <f7-nav-left>
        <f7-link @click="$router.back()"><i class="iconfont icon-left-arrow"></i></f7-link>
      </f7-nav-left>
      <f7-nav-center>本月优免记录</f7-nav-center>
      <f7-nav-right>
        <f7-link @click="$router.load({url:'/historyrecord'})"><span>历史记录</span></f7-link>
      </f7-nav-right>
    </f7-navbar>
      <div class="month-fee">
        <div class="month-fee-content">
          <div class="month-fee-content-num">128</div>
          <div class="month-fee-content-txt">本月累计优免(小时)</div>
        </div>
      </div>
...
<style rel="stylesheet/scss" lang="scss">
  #feeRecord {
    ...
    .month-fee {
      ...
      .month-fee-content {
        text-align: center;
        .month-fee-content-num {
          font-size: 80px;
        }
        .month-fee-content-txt {
          font-size: 28px;
        }
      }
    }
